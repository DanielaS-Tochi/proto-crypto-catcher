...
const Footer = () => {
    const socialLinks = [
        {
            name: 'GitHub',
            url: 'https://github.com/danielas-tochi',
            icon: (
        ...
        {
            name: 'LinkedIn',
            url: 'https://linkedin.com/in/daniela-silvana-tochi',
            icon: (
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        {
            name: 'X (Twitter)',
            url: 'https://x.com/DanielaDevWeb3',
            icon: (
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        {
            name: 'Farcaster',
            url: 'https://warpcast.com/danidev3',
            icon: (
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M2 5v14h5v-9h3v9h4v-9h3v9h5V5H2z" />
                </svg>
            )
        }
    ];
